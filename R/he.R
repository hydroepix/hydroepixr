...
# Set up simulation environment based on data files and parameters
#he_set_up_simulation_env(simulation_env, farm_info_filepath, types_filepath, dist_mat_filepath)
