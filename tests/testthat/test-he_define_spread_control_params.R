test_that("default spread parameters are stored in the environment", {
  ...
  expect_equal(test_environment$index_infection_stage, "subclinical-clinical split")
...
test_that("user-defined spread parameters stored in the environment", {
  ...
  expect_equal(test_environment$index_infection_stage, test_index_infection_stage)
...
test_that("clinically_inf_prop is correctly modified by vaccine_efficacy", {
  ...
  expect_equal(test_environment$netpen_to_netpen, test_netpen_to_netpen)
  expect_equal(test_environment$vaccine_efficacy, test_vaccine_efficacy)
  expect_equal(test_environment$clinically_infected_prop, test_effective_clinically_infected_prop)
})
