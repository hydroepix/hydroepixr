test_that("subclinical-clinical split is calculated correctly with no animals
  transitioning between infection stages", {
...
test_that("subclinical-clinical split is calculated correctly with no clinical
  infection", {
...
test_that("subclinical-clinical split is calculated correctly with guaranteed clinical
  infection", {
  test_n_transitioning <- 1000
...
test_that("subclinical-clinical split is calculated correctly with clinical infection
  for a single row", {
  test_n_transitioning <- 1000
...
test_that("subclinical-clinical split is calculated correctly with clinical infection
  ...
  expected_subclinical_clinical_infection_split <- rbind(
    cbind(1000, 1000),
    cbind(500, 500)
  )
  expect_equal(
